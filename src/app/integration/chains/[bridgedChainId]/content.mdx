...
{/** @import {Props} from './content.types.ts' */}
...
and [General Information](/general-information) about the integrations.

Then, all you need to do is

- write your smart contract that integrated with Bridged Biomapper on
  {props.bridgedChain.generalDisplayName} chain, and
...
Please use <DataLink link="biomapperSdkDocs">Biomapper SDK</DataLink> to get
