---
description: Information on how to integrate on the frontend with Biomapper.
---
...
Integrating on the frontend with Biomapper on Humanode chain is a simple process of 2 contract calls.
...
```ts
const biomapperContractAddress = "0x877Bb6c2d22918563c4688e68b62c2F678Cc0BFD";
```

For the Biomapper on Humanode Testnet 5:

```ts
const biomapperContractAddress = "0x3f2B3E471b207475519989369d5E4F2cAbd0A39F";
```
