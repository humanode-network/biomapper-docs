...
## Accessing the Generations Historical Data

See the [#generations-historical-data](technical-information/on-chain-data.md#generations-historical-data "mention") page to learn how to access the generations' information on-chain.
